...
#party images to compare with main image
...
for c in contours:
    ...
    if ((len(approx) == 4) & (area>1000000) & (area<2000000)):
        ...
        for c1 in contours2:
            ...
            if ((len(approx1) == 4) & (area1>20000) & (area1<28000)):
                ...
                #Marking the area with a rectangle
                cv2.rectangle(warped3,(xa2,ya1),((int)(xa2+120),ya2),(255,0,0),3)
                #Taking the voing box images
                ...
                #Counting black pixels in the voting area
        ...
        for k in range(11):
            #Recognize images from template matching
    ...
    if ((len(approx) == 4) & (area>200000) & (area<300000)):
        ...
        #Creating new image from selected area
